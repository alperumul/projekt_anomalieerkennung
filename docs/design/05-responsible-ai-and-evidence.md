...
|---|---|---|---|---|---|---|
| 2026-07-22 | Codex | Is the initial split usable? | Challenged the split and proposed survival checks. | The earlier verifier and counts remain preserved in Git history. | Superseded by the jointly approved 2026-07-24 structure | Proposed the earlier train-core/train-tail/test design. |
